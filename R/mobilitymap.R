...
#' @export mobilitymap
#' @param x the data.frame containing the degree (mobility parameter) and the GPS coordiantes (column names: LONGITUDE_X and LATITUDE_Y) \cr FR: le data.frame contenant le degre (parametre de mobilite) et les coodonnees GPS (nom des colonnes : LONGITUDE_X et LATITUDE_Y).
